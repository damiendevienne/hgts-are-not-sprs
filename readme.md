...
- `Simulations.R` contains the few functions used to (i) compute all the results presented in the article and saved in the file `allresults`, and (ii) plot the results (the two figures are given in folder `figs/`). 
